...
AA['A_1'] = fuzz.trimf(AA.universe, [-2, -1, 0])
AA['A_2'] = fuzz.trimf(AA.universe, [-1,0,1])
AA['A_3'] = fuzz.trimf(AA.universe, [0, 1, 2])

BB['B_1'] = fuzz.trimf(BB.universe, [-2, -1, 0])
BB['B_2'] = fuzz.trimf(BB.universe, [-1,0,1])
BB['B_3'] = fuzz.trimf(BB.universe, [0, 1, 2])

CC['C_1'] = fuzz.trimf(CC.universe, [-1, -1, 0])
CC['C_2'] = fuzz.trimf(CC.universe, [-1, 0, 1])
CC['C_3'] = fuzz.trimf(CC.universe, [0, 1, 1])
...
regula3 = ctrl.Rule(AA['A_2'] & BB['B_2'], CC['C_3'] )
